...
Cambiate gli attributi di Time con un singolo intero che rappresenta
i secondi dalla mezzanotte. Quindi modificate i metodi (e la funzione int_to_tempo) in
modo che funzionino con la nuova implementazione. Non dovete cambiare il codice di prova
in main. Quando avete finito, l’output dovrebbe essere lo stesso di prima. 
"""
